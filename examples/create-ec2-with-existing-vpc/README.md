...
| <a name="input_primary_instance_type"></a> [primary\_instance\_type](#input\_primary\_instance\_type) | Choose the required primary/Secondary node instance type. Valid values are c5.4xlarge , m5.4xlarge, c5.9xlarge, t3.xlarge | `string` | `"t3.xlarge"` |
